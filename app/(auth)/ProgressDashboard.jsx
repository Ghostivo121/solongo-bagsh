...
import { DEGREE_DATA } from "../../data/MockData";
    ...
    <ThemedView style={styles.container}>
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        ...
        <View style={styles.header}>
          ...
          <ThemedText style={styles.headerTitle}>Сургалтын төлөвлөгөө</ThemedText>
          <View style={{ width: 40 }} />
        </View>
                ...
                <View style={styles.expandContent}>
                  {cat.completedLessons.length > 0 && (
                    <View style={styles.subSection}>
                      <ThemedText style={styles.subSectionTitle}>Судалсан хичээл</ThemedText>
...
const styles = StyleSheet.create({
  ...
  summaryCard: { backgroundColor: '#7D1616', borderRadius: 24, padding: 24, flexDirection: 'row', alignItems: 'center', marginBottom: 24, elevation: 4 },
  ...
  subSectionTitle: { fontSize: 10, fontWeight: '800', color: '#90A4AE', marginBottom: 10, letterSpacing: 0.5 },
  ...
  lessonRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.02)' },
  lessonInfo: { flex: 1 },
  lessonName: { fontSize: 14, fontWeight: '500', color: '#37474F' },
  lessonDetail: { fontSize: 11, color: '#90A4AE', marginTop: 2 },
});
